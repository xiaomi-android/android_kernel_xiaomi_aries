...
union f1a_0d_query {
	struct {
		...
		bool has_general_control:1;
		bool has_interrupt_enable:1;
		bool has_multibutton_select:1;
		bool has_tx_rx_map:1;
		bool has_perbutton_threshold:1;
		bool has_release_threshold:1;
		bool has_strongestbtn_hysteresis:1;
		bool has_filter_strength:1;
...
static void f1a_remove_device(struct rmi_function_container *fc)
{
	struct f1a_data *f1a = fc->data;
